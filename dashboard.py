...
if fl is not None:
  ...
  os.chdir(r"D:\DATA E\belajar_coding_website\STREAMLIT_1\Superstore")
...
# Filter the data on Region, State and City
...
# Create a treem base o Region, Category, sub Category
